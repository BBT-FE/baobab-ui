<transition
  ...
  <div
    ...
    :style="{zIndex: zIndex}"
  >
    <div class="Toast--main" :class="{onlyText: type === 'text', wifi: type === 'wifi', loadingB: type === 'loadingB', loadingA: type === 'loadingA'}">
      <div class="Toast--icon" v-if="type !== 'text'">
      ...
      <div class="Toast--content" v-if="content || type === 'loadingB'">{{content}}</div>
    </div>
  </div>
</transition>
